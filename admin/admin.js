...
;(function ($, s) {
	...
	$(document).ready(function () {
		...
		var subscribe = function() {}, state = { yoast: false, rankmath: false, featured: false };
		...
		monitor_title_field();
		subscribe(function() { monitor_title_field() });
	});
